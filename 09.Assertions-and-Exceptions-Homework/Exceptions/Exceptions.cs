...
internal class Exceptions
{
    public static T[] Subsequence<T>(T[] arr, int startIndex, int count)
    {
        ...
        {
            throw new ArgumentOutOfRangeException("startIndex", "StartIndex should be in range [0...arr.Length - 1]");
        }

        if (count > arr.Length)
        {
            throw new ArgumentOutOfRangeException("count", "Count should be smaller than array length");
        }
    ...
    public static string ExtractEnding(string str, int count)
    {
        if (count > str.Length)
        {
            throw new ArgumentOutOfRangeException("count", "Count should be smaller than string's length");
        }
    ...
    private static void Main()
    {
        ...
        Console.WriteLine("23 is {0}.", IsPrime(23) ? "prime" : "not prime");
        Console.WriteLine("33 is {0}.", IsPrime(23) ? "prime" : "not prime");
