    ...
    public class House : IHouse
    {
        ...
        public string Name
        {
            ...
            private set
            {
                if (value == null)
                {
                    throw new ArgumentNullException("value", EmptyHouseNameErrorMessage);
                }
        ...
        public void RemoveCityFromHouse(string cityName)
        {
            ...
            if (city == null)
            {
                throw new ArgumentNullException("cityName", string.Format(CityNotFoundErrorMessage, this.Name));
            }
